# GO plot comparing multiple analyses to one reference analysis
# By Ben Laufer
...
REVIGO <- function(GO = GO,
  ...
  # Modified from: https://github.com/hbc/revigoR/blob/master/rvest_revigo.R
